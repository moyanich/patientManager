...
<head>
    ...
    <title>{{ config('app.name', 'Patient Care') }}</title>
...
<body>
    ...
    <div class="d-flex flex-column flex-lg-row h-lg-full bg-gray-100">
        ...
        <!-- Main content -->
        <div class="h-screen px-lg-7 flex-grow-1 overflow-y-lg-auto">
                   ...
                   <div class="mb-npx">
                      <div class="row align-items-center">
                         <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                            <h1 class="h2 ls-tight"><span class="d-inline-block me-3">👋</span>Welcome!</h1>
                         </div>
