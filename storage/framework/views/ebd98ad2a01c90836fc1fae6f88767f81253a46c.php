<?php $__env->startSection('header'); ?>
    <div class="row align-items-center">
        <div class="col-md-6 col-12 mb-3 mb-md-0">
            <!-- Title -->
            <h1 class="h2 mb-0 ls-tight"><?php echo e(__('Departments')); ?></h1>
        </div>
        <!-- Actions -->
        <div class="col-md-6 col-12 text-md-end">
            <div class="mx-n1">
                <a href="<?php echo e(route('departments.create')); ?>" class="btn d-inline-flex btn-sm btn-primary mx-1">
					<span class=" pe-2">
						<i class="bi bi-plus"></i>
					</span>
                	<span><?php echo e(__('Add Department')); ?></span>
                </a>
            </div>
        </div>
    </div>
            ...
            <div class="mb-7">
                    ...
                    <table id="department-datatable" class="table table-nowrap compact department-datatable">
                        <thead>
                            <tr>
                                ...
                                <th scope="col"><?php echo e(__('Department Name')); ?></th>
                                <th scope="col"><?php echo e(__('Department Head')); ?></th>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('department-delete')): ?>
                    <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <!-- Modal -->
                        <div class="modal" id="delDepModal-<?php echo e($department->id); ?>" tabindex="-1" aria-labelledby="delDepModal" aria-hidden="true">
...
<script>
    $(document).ready( function () {
        ...
        $('#department-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo route('departments.index'); ?>",
            columns: [
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard', ['page' => __('Department Management')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/patientManager/resources/views/departments/index.blade.php ENDPATH**/ ?>