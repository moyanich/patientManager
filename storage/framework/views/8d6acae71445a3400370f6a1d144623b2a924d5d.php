...
<head>
    ...
    <title><?php echo e($page); ?> - <?php echo e(config('app.name', 'Patient Care')); ?></title>
                   ...
                   <div class="mb-npx">
                      <div class="row align-items-center">
                         <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                            <h4 class="ls-tight text-light"><span class="d-inline-block me-3">👋</span>Welcome! <?php echo e(Auth::user()->name); ?></h4>
                         </div>
...
<?php /**PATH /Applications/MAMP/htdocs/patientManager/resources/views/layouts/dashboard.blade.php ENDPATH**/ ?>